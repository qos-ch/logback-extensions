...
/**
 * Lazy copy of the {@link ch.qos.logback.core.AsyncAppenderBase}.
 * There is only 1 different - worker will be initialized in the start process.
 */
public class LazyAsyncAppenderBase<E> extends UnsynchronizedAppenderBase<E> implements AppenderAttachable<E> {
    ...
    class Worker extends Thread {
        ...
        public void run() {
            LazyAsyncAppenderBase<E> parent = LazyAsyncAppenderBase.this;
